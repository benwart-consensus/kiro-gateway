...
async def verify_anthropic_api_key(
    ...
    Expects format: "Authorization: Bearer {PROXY_API_KEY}"

    Args:
        credentials: Parsed Bearer token from Authorization header
    ...
    """
    if credentials and credentials.credentials == PROXY_API_KEY:
        return True
